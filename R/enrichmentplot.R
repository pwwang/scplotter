...
#'
#' @param data A data frame with enrichment results generated by \code{clusterProfiler}.
#'  If your result is generated by \code{enrichr}, you can use \code{\link{PrepareEnrichrResult}} to convert it to a data frame.
...
#'  See also \code{\link{plotthis::BarPlot}}.
...
#'  See \code{\link{plotthis::show_palettes}} for available palettes.
...
#'  * For "bar", \code{\link{plotthis::BarPlot}}
#'  * For "dot", \code{\link{plotthis::DotPlot}}
#'  * For "lollipop", \code{\link{plotthis::LollipopPlot}}
#'  * For "network", \code{\link{plotthis::EnrichNetwork}}
#'  * For "enrichmap", \code{\link{plotthis::EnrichMap}}
#'  * For "wordcloud", \code{\link{plotthis::WordCloudPlot}}
#'  * For "comparison", \code{\link{plotthis::DotPlot}}
