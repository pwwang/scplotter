...
#' An example results from enrichr
#'
#' The variable "enrichr_example" represents an example results from enrichr.
#' @concept data
#' @name enrichr_example
NULL

#' An example results from enrichr with multiple databases
#'
#' The variable "enrichr_multidb_example" represents an example results from enrichr with multiple databases.
#' @concept data
#' @name enrichr_multidb_example
NULL
