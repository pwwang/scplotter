...
The features can include expression, dimension reduction components,
metadata, etc
...
- features:
  ...
  `SpatFeaturePlot()`, the plots will be faceted by the features.
...
- <https://pwwang.github.io/scplotter/articles/Knowing_your_spatial_data_and_visualization.html>
  for more details, and

- <https://pwwang.github.io/scplotter/articles/Knowing_your_spatial_data_and_visualization.html#examples>
  for examples.
