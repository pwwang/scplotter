...
#> prompt
#> Code ran:
#> CCCPlot(cellphonedb_res, plot_type = "heatmap", title = "Cell-Cell Communication")
```
...
#> [6] "Assistant: tool - CCCPlot; data - scplotter::cellphonedb_res; code - CCCPlot(cellphonedb_res, plot_type = \"heatmap\", title = \"Cell-Cell Communication\")"
